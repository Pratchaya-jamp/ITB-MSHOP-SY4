...
//        refreshCookie.setPath("/v2/auth/refresh"); // จำกัด path ให้เฉพาะ refresh endpoint
//        refreshCookie.setMaxAge(24 * 60 * 60); // 1 วัน
//        response.addCookie(refreshCookie);
//
//        // return access_token เท่านั้นใน body
//        return ResponseEntity.ok(new LoginResponseDto(tokens.getAccess_token(), null));
//    }
    ...
    public ResponseEntity<Void> logout(HttpServletResponse response,
        ...
        cookie.setPath("/v2/auth/refresh");
