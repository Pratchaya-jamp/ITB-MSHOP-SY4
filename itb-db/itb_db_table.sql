...
createdOn datetime not null default (convert_tz(current_timestamp, 'UTC', 'Asia/Bangkok')),
updatedOn datetime not null default (convert_tz(current_timestamp, 'UTC', 'Asia/Bangkok')) on update (convert_tz(current_timestamp, 'UTC', 'Asia/Bangkok')),
